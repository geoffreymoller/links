...
(function (window, undefined) {
  ...
  EpicEditor.prototype.resize = function(dimensions) {
    var self = this;
    var elements = [self.iframeElement, self.editorIframe, self.previewerIframe]
    for (var x = 0; x < elements.length; x++) {
      dimensions.w && (elements[x].style.width = dimensions.w);
      dimensions.h && (elements[x].style.height = dimensions.h);
    };
    return self;
  }
